...
function Limpatxt() {
  ...
  document.getElementById("tci4").value = "";
}
...
function TCI4() {
  valores.escreveu4 = document.getElementById("tci4").value;
  Limpatxt();
}

function Mostrar4() {
  var escrita4 = document.getElementById("Verificar4");
  escrita4.innerHTML = valores.escreveu4;
  Limpatxt();
}
